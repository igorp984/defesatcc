    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(unique=True, max_length=30, verbose_name=b'Nome do Usu\xc3\xa1rio', validators=[django.core.validators.RegexValidator(re.compile(b'^[\\w.@+-]+$'), b'o nome de usu\xc3\xa1rio s\xc3\xb3 pode conter letras, digitos os os seguintes caracteres @ . + - _', b'invalid')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='resets', verbose_name=b'Usu\xc3\xa1rio', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created_at'],
        ...
        migrations.AddField(
            model_name='usuario',
            name='titulo',
            field=models.ForeignKey(related_name='titulo', verbose_name=b'Titula\xc3\xa7\xc3\xa3o', to='accounts.Titulo'),
        ),
        migrations.AddField(
            model_name='usuario',
